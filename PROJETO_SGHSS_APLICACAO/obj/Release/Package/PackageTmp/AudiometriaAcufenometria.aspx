<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AudiometriaAcufenometria.aspx.cs" Inherits="SISTEMASLUASAUDE_APLICACAO.AudiometriaAcufenometria" %>
        ...
        <div id="geral" runat="server" style="margin-top: 50px; margin-bottom: 50px; width: 100%; height: 100%; align-items: stretch; vertical-align: central">
            ...
            <div class="container" style="text-align: center; width: 100%;">
                <div class="box">
                    ...
                    <div style="width: 100%;">
                        <%--abas--%>
                        <div class="tab-button" style="width: 12%; border-style: solid; border-width: 1px; font-size: medium;" onclick="showTab('tabPlotar')"><b>Plotar</b></div>
                                                    ...
                                                    <asp:Table ID="tbDadosOD" runat="server" Width="100%">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Red" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 500Hz e 750Hz na VO.">
                                                                <asp:CheckBox ID="liga500_750vo_ODCheckBox" runat="server" ToolTip="Liga as simbologias de 500Hz e 750Hz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Red" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 750Hz e 1kHz na VO.">
                                                                <asp:CheckBox ID="liga750_1kvo_ODCheckBox" runat="server" ToolTip="Liga as simbologias de 750Hz e 1kHz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Red" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 1kHz e 1,5kHz na VO.">
                                                                <asp:CheckBox ID="liga1k_1_5kvo_ODCheckBox" runat="server" ToolTip="Liga as simbologias de 1kHz e 1,5Hz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Red" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 1,5kHz e 2kHz na VO.">
                                                                <asp:CheckBox ID="liga1_5k_2kvo_ODCheckBox" runat="server" ToolTip="Liga as simbologias de 1,5kHz e 2kHz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
                                                ...
                                                <asp:Panel ID="pnlGridDadosOE" runat="server" Width="467px" BackColor="AliceBlue" BorderColor="Blue" BorderStyle="Solid" BorderWidth="1">
                                                    <asp:Table ID="tbDadosOE" runat="server" Width="100%">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Blue" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 500Hz e 750Hz na VO.">
                                                                <asp:CheckBox ID="liga500_750vo_OECheckBox" runat="server" ToolTip="Liga as simbologias de 500Hz e 750Hz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Blue" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 750Hz e 1kHz na VO.">
                                                                <asp:CheckBox ID="liga750_1kvo_OECheckBox" runat="server" ToolTip="Liga as simbologias de 750Hz e 1kHz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Blue" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 1kHz e 1,5kHz na VO.">
                                                                <asp:CheckBox ID="liga1k_1_5kvo_OECheckBox" runat="server" ToolTip="Liga as simbologias de 1kHz e 1,5kHz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
                                                        ...
                                                        <asp:TableRow Width="100%" ForeColor="Blue" Font-Bold="true" Font-Size="14">
                                                            ...
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Liga as simbologias de 1,5kHz e 2kHz na VO.">
                                                                <asp:CheckBox ID="liga1_5k_2kvo_OECheckBox" runat="server" ToolTip="Liga as simbologias de 1,5kHz e 2kHz na VO."/>
                                                            </asp:TableCell>
                                                            <asp:TableCell Width="10%" Height="30px" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1">
