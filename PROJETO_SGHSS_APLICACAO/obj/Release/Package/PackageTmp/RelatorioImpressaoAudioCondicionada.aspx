<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioImpressaoAudioCondicionada.aspx.cs" Inherits="SISTEMASLUASAUDE_APLICACAO.RelatorioImpressaoAudioCondicionada" Debug="true" %>
    ...
    <form id="frmLogin" runat="server" style="width: 100%; height: 100%">
        ...
        <div id="geral" runat="server" style="margin-top: 40px; margin-bottom: 50px; width: 100%; height: 100%; align-items: stretch; vertical-align: central">
            ...
            <rsweb:ReportViewer ID="rpvRelatorioImpressaoAudioClinConv" runat="server" Width="100%" Height="570px" BackColor="White" AsyncRendering="false" ClientIDMode="AutoID" HighlightBackgroundColor="" InternalBorderColor="204, 204, 204" InternalBorderStyle="Solid" InternalBorderWidth="1px" LinkActiveColor="" LinkActiveHoverColor="" LinkDisabledColor="" PrimaryButtonBackgroundColor="" PrimaryButtonForegroundColor="" PrimaryButtonHoverBackgroundColor="" PrimaryButtonHoverForegroundColor="" SecondaryButtonBackgroundColor="" SecondaryButtonForegroundColor="" SecondaryButtonHoverBackgroundColor="" SecondaryButtonHoverForegroundColor="" SplitterBackColor="" ToolbarDividerColor="" ToolbarForegroundColor="" ToolbarForegroundDisabledColor="" ToolbarHoverBackgroundColor="" ToolbarHoverForegroundColor="" ToolBarItemBorderColor="" ToolBarItemBorderStyle="Solid" ToolBarItemBorderWidth="1px" ToolBarItemHoverBackColor="" ToolBarItemPressedBorderColor="51, 102, 153" ToolBarItemPressedBorderStyle="Solid" ToolBarItemPressedBorderWidth="1px" ToolBarItemPressedHoverBackColor="153, 187, 226">
                <LocalReport ReportPath="RelatoriosImpressao\rltAudioCondicionada.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
        </div>
    </form>
