<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioImpressaoAudioClinicaConvencional_Analitico.aspx.cs" Inherits="SISTEMASLUASAUDE_APLICACAO.RelatorioImpressaoAudioClinicaConvencional_Analitico" Debug="true" %>
...
<body class="custom-font" style="background-color: white; height: 100%" >
    <form id="frmLogin" runat="server" style="width: 100%; height: 100%">
        <header>
            <b>Relatório de Impressão: Audiometria Clínica Convencional</b>
        </header>
