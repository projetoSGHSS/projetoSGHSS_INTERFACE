<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AudiometriaClinicaConvencional.aspx.cs" Inherits="SISTEMASLUASAUDE_APLICACAO.AudiometriaClinicaConvencional" %>
    ...
    <form id="frmAudiometriaClinica" runat="server" style="width: 100%;">
        ...
        <div id="geral" runat="server" style="margin-top: 50px; margin-bottom: 50px; width: 100%; height: 100%; align-items: stretch; vertical-align: central">
            ...
            <div class="container" style="text-align: center; width: 100%;">
                <div class="box">
                    <br />
                    <div style="width: 100%; background-color: #8FBC8F; text-align: left; vertical-align: bottom;">
                    ...
                    <div style="width: 100%;">
                        ...
                        <div class="tab-button" style="width: 15%; border-style: solid; border-width: 1px; font-size: medium;" onclick="showTab('tabVocal')"><b>Audiometria Vocal</b></div>
                        <div class="tab-button" style="width: 15%; border-style: solid; border-width: 1px; font-size: medium;" onclick="showTab('tabLaudo')"><b>Laudo ou Parecer</b></div>
                        ...
                        <%--conteúdos das abas--%>
                        <div id="tabPlotar" class="tab-content active-tab" style="width: 100%;">
                        ...
                        <div id="tabWeber" class="tab-content" style="width: 100%; border-color: #cccccc; border-width: 2px; border-style: Solid;">
                            <div class="container" style="text-align: center;">
                        ...
                        <div id="tabVocal" class="tab-content" style="width: 100%;">
                        ...
                        <div id="tabLaudo" class="tab-content" style="width: 100%;">
                        ...
                        <div id="tabImpressao" class="tab-content" style="width: 100%;">
