...
window.onload = function () {
    var chartElementOD = document.getElementById("chartAudioOD"); // ID do primeiro gráfico
    var chartElementOE = document.getElementById("chartAudioOE"); // ID do segundo gráfico
